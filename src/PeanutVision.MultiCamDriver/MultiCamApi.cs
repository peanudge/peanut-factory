...
/// <summary>
/// MultiCam status codes (MCSTATUS) — from McDef.h
/// </summary>
public enum McStatus
{
	...
	MC_PARAMETER_ILLEGAL_ACCESS = -23,
	MC_CLUSTER_BUSY = -24,
	MC_SERVICE_ERROR = -25,
	MC_INVALID_SURFACE = -26,
	MC_BAD_GRABBER_CONFIG = -101,
	MC_ILLEGAL_PAGELENGTH_VALUE = -102,
}

/// <summary>
/// MultiCam signal types for callback/wait operations — from McDef.h
/// </summary>
