...
public class AcquisitionLifecycleTests : IClassFixture<PeanutVisionApiFactory>, IAsyncLifetime
{
    private readonly HttpClient _client;

    public AcquisitionLifecycleTests(PeanutVisionApiFactory factory)
    {
